    ...
    <View style={{ flex: 1, backgroundColor: '#f5f5f5', position: 'relative' }}>
      ...
      <View style={{ flex: 1, flexDirection: 'row' }}>
        ...
        <View style={{ flex: 1 }} {...panResponder.panHandlers}>
          ...
          {view === 'sasi'   && <SasiScreen sasiStock={sasiStock} setSasiStock={setSasiStock} opsBasket={sasiOps} setOpsBasket={setSasiOps} stockHighlight={globalSearchStockMeta} onClearSearchHighlight={clearSearchNavigationHighlight} locked={isGuest || unlockedTab !== 'sasi'} isAdmin={isAdmin} />}
          {view === 'cases'  && <CaseScreen caseStock={caseStock} setCaseStock={setCaseStock} opsBasket={caseOps} setOpsBasket={setCaseOps} stockHighlight={globalSearchStockMeta} onClearSearchHighlight={clearSearchNavigationHighlight} locked={isGuest || unlockedTab !== 'cases'} isAdmin={isAdmin} />}
