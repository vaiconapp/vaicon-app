          ...
          <View style={styles.prodContainer}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.phaseTabs}>
              ...
              <TouchableOpacity
                ...
                <Text style={styles.phaseTabCount}>{prodOrders.filter(o=>o.stavera&&o.stavera.filter(s=>s.dim).length>0).length + specialOrders.filter(o=>o.status==='READY'&&o.staveraPendingAtReady&&!o.staveraDone).length}</Text>
              </TouchableOpacity>
            </ScrollView>
