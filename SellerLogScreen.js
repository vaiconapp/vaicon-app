...
// Στήλες: Όνομα πελάτη · Όνομα πωλητή · Όνομα καταχωρητή.
        ...
        <ScrollView style={{ flex: 1 }}>
          {filtered.length === 0 ? (
            ...
            <View key={r.id} style={[styles.row, i % 2 ? styles.rowOdd : styles.rowEven]}>
              ...
              <Text style={[styles.td, { flex: 1.3, color: '#1565C0', fontWeight: 'bold' }]}>{resolveLabel(r.seller) || r.seller || '—'}</Text>
...
const styles = StyleSheet.create({
  ...
  refresh: { backgroundColor: '#1565C0', borderRadius: 8, paddingHorizontal: 14, justifyContent: 'center' },
  refreshTxt: { color: '#fff', fontSize: 16 },
  row: { flexDirection: 'row', paddingHorizontal: 12, paddingVertical: 8, alignItems: 'center' },
  rowEven: { backgroundColor: '#fff' },
  rowOdd: { backgroundColor: '#eef2f7' },
