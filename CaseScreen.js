...
export default function CaseScreen({ caseStock={}, setCaseStock }) {
  ...
  return (
    <View style={{flex:1, backgroundColor:'#f5f5f5'}}>
      ...
      {/* ΚΟΥΜΠΙΑ ΕΚΤΥΠΩΣΗΣ μέσα στο sectionHeader */}
